...
<html>
    ...
    <body>
            ...
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{ isActive('LaravelInstaller::purchase_code') }}">
                        @if(Request::is('install/purchase-code') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaravelInstaller::purchase_code') }}">
                                <i class="step__icon fa fa-unlock" aria-hidden="true"></i>
                            </a>
                        @else
                            <i class="step__icon fa fa-unlock" aria-hidden="true"></i>
                        @endif
        ...
        @yield('scripts')
{{--        <script src="{{ asset('js/installer/master.js') }}"></script>--}}
    </body>
</html>
